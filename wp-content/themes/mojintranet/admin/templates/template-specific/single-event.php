...
function event_details_callback($post) {
  ...
  <table>
    ...
    <tr>
      ...
      <td class='event-times'><input type='' id='<?=$ns?>-start-time' name='<?=$ns?>-start-time' value='<?=$post_meta['_'.$ns.'-start-time'][0]?>' class='timepicker'></td>
    </tr>
    <tr>
      <td>End Date:</td>
      ...
      <td class='event-times'><input type='' id='<?=$ns?>-end-time' name='<?=$ns?>-end-time' value='<?=$post_meta['_'.$ns.'-end-time'][0]?>' class='timepicker'></td>
