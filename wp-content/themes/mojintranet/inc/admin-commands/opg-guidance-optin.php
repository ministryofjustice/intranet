...
class OPG_Guidance_Optin extends Admin_Command {
    /**
     * Name of the command.
     *
     * @var string
     */
    public $name = 'OPG Guidance Opt-in';
     ...
     * @var string
     */
    public $description = 'Opt-in OPG to all HQ Guidance pages below the HQ main Guidance page';
    ...
    public function opt_in_page($page_id) {
        wp_set_object_terms($page_id, 'opg', 'agency', true);
