...
add_action(
	...
	function () {
		...
		register_rest_route(
			'intranet/v2/',
			'future-events/(?P<agency>[a-zA-Z0-9-]+)/',
			array(
				'methods'             => 'GET',
		...
		register_rest_route(
			'intranet/v2/',
			'future-events/(?P<agency>[a-zA-Z0-9-]+)/(?P<search>[a-z0-9]+(?:-[a-z0-9]+)*)/',
			array(
				'methods'             => 'GET',
				'callback'            => 'add_custom_events_endpoint',
				'args'                => array(
		...
		register_rest_route(
			'intranet/v2/',
			'region-events/(?P<agency>[a-zA-Z0-9-]+)/(?P<region>[a-z0-9]+(?:-[a-z0-9]+)*)',
			array(
				'methods'             => 'GET',
		...
		register_rest_route(
			'intranet/v2/',
			'region-events/(?P<agency>[a-zA-Z0-9-]+)/(?P<region>[a-z0-9]+(?:-[a-z0-9]+)*)/(?P<postcount>[a-z0-9]+(?:-[a-z0-9]+)*)',
			array(
				'methods'             => 'GET',
				'callback'            => 'add_region_events_endpoint',
				'args'                => array(
		...
		register_rest_route(
			'intranet/v2/',
			'campaign-events/(?P<agency>[a-zA-Z0-9-]+)/(?P<campaign>[a-z0-9]+(?:-[a-z0-9]+)*)/',
			array(
				'methods'             => 'GET',
