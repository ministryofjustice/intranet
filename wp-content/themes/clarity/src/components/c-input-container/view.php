  ...
  <div class="c-input-container c-input-container--<?php echo $type ?>">
    ...
    <?php if ($label != false): ?>
      ...
      if ($type !== 'select') {
        ...
        <<?php echo $tag; ?> type="<?php echo $type; ?>" name="<?php echo $name ?>" id="<?php echo $id; ?>" <?php if ($type !== 'textarea') {
              ?> value="<?php echo $value; ?>" <?php
          } ?> <?php echo $class .' '. $required .' '. $validation .' '. $placeholder ?>><?php if ($type === 'textarea') {
              echo $value ?></textarea>
        <?php
          }
      } else {
