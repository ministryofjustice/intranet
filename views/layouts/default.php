...
<!--[if IE 6 ]> <html <?php language_attributes(); ?> class="ie6 lte-ie7 template-<?=$template_class?>"> <![endif]-->
<!--[if IE 7 ]> <html <?php language_attributes(); ?> class="ie7 lte-ie7 template-<?=$template_class?>"> <![endif]-->
