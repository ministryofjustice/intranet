...
// A string containing the header for the component register
 var regHeader = '<!DOCTYPE html><html lang=en><head><meta charset=UTF-8><title>Clarity component register</title><link rel=stylesheet href=https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css><style>body{padding:10px 10%}table{width:100%;margin-bottom:20px;border:1px solid #ccc;margin-top:20px}thead th{background-color:#ccc;padding:10px}tr:nth-child(even){background-color:#f4f4f4}td,th{padding:5px 10px}h1{margin-bottom:20px}.glyphicon{margin-right:1rem}</style></head> <body> <h1>Component Register</h1> <p>This document is a list of all of the components that the clarity theme currently has available. Please do not edit this file, it is generated automatically. To regenerate it type `node genreg` in the project root.</p> <table> <thead> <tr> <th>Component Name</th> <th>Latest version</th> <th>Author</th> <th>Description</th> <th>JS?</th> </tr> </thead> <tbody>'
...
// Generate a HMTL table row with all the component data
 var createRows = function (obj) {
   ...
   var integratedStatus = obj.integrated ? 'glyphicon-ok-sign alert-success' : 'glyphicon-exclamation-sign alert-danger'
   return ('<tr"><td><span class="glyphicon ' + integratedStatus + '"></span>' + obj.name + '</td><td>' + obj.version + '</td><td><a href="http://github.com/' + obj.creator.github_username + '">' + obj.creator.name + '</a></td><td>' + obj.description + '</td><td>' + jsStat + '</td></tr>')
 }
