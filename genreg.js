...
var createRows = function(obj) {
    ...
    var screenshot = (obj.screenshot) ? '<th> Screenshot : </th><td><img style="width:300px;height:auto" src="' + obj.screenshot + '" alt="screenshot of ' + obj.name + '"/></td>' : ''
