...
class HelperSearch
{
    ...
    private function convert_post_type($post_type)
    {
        switch ($post_type) {
            case 'all':
                $post_type = array( 'page', 'regional_page', 'regional_news', 'news', 'document', 'webchat', 'event', 'post', 'team_news', 'note-from-amy', 'note-from-antonia' );
                break;

            case 'content':
                $post_type = array( 'page', 'regional_page', 'regional_news', 'news', 'webchat', 'event', 'post', 'team_news', 'note-from-amy', 'note-from-antonia' );
                break;
        }
