...
if (isset($post_meta['comment_disabled_status'][0])) {
  ...
  $comments_args = [
      ...
      'label_submit'  => 'Add message',
      'comment_field' => '<p class="comment-form-comment">
      <textarea required id="comment" name="comment" placeholder="' . esc_attr__('Enter your message here...', 'text-domain') . '" cols="45" rows="8" aria-required="true"></textarea>
      </p>',
  ];
    ?>
...
<section class="c-comment-form">
  <h1 class="o-title o-title--subtitle">Leave a message</h1>
    <?php
