    ...
    if (!$maintenance_mode) {
      ...
      <?php
        if (is_user_logged_in()) { ?>
          <p>
            Your email address and comment will be shared with the author and Intranet Editors. See the <a href="<?= get_bloginfo('url'); ?>/privacy-notice/">Intranet Privacy Policy</a> for more information.
        </p>
        <?php
      ...
      <p class="secondary-action">
        <a href="<?= $blog_info_url ?>/commenting-policy/">MoJ commenting policy</a><br/>
        <a href="<?= $blog_info_url ?>/delete-account/">Delete your comment history</a>
      </p>
      <?php
    } else {
