...
<article class="c-blog-article-item">
  ...
  <a class="c-blog-article-item--thumbnail" href="<?= esc_url(get_permalink($id)) ?>">
  ...
  <div class="text-align">
    <section class="c-article-byline">
      <div class="c-article-byline__intro">
        By <strong><?= esc_attr($authors[0]['name']) ?></strong>
      </div>
      <div class="c-article-byline__date">
        <?= get_the_date('d F Y', $id) ?>
      </div>
    </section>

    <div class="c-blog-article-item__excerpt"><p><?= get_the_excerpt($id) ?></p></div>
  </div>
