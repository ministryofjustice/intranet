...
$redis_server = array(
	...
	'port'     => 6379,
	'auth'     => env('WP_REDIS_PASSWORD'),
	'database' => 1, // Optionally use a specific numeric Redis database. Default is 0.
);

define( 'WP_REDIS_USE_RELAY', true );
...
class WP_Object_Cache {
	...
	public function perform_client_connection( $redis, $client_parameters, $keys_methods ) {
        // print_r($client_parameters);
        // print_r($keys_methods);
		foreach ( $keys_methods as $key => $method ) {
            ...
            // }
			try {
                // echo 'calling $redis->' . $method . ' with value ' . $client_parameters[ $key ];
