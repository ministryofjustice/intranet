...
create_placeholders() {
	echo "# placeholder" > /etc/nginx/whitelists/wp-login.conf
	echo "# placeholder" > /etc/nginx/whitelists/site-wide.conf
}

# This was done in the Dockerfile in the old container.
create_placeholders
