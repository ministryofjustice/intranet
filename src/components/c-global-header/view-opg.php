...
<head>
  ...
  <link rel="canonical" href="http://mojintranet/" />
  <!--[if lt IE 9]>
    <script type="text/javascript" src="<?php echo get_assets_folder(); ?>/vendors/selectivizr-min.js"></script>
