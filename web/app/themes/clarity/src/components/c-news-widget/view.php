...
<!-- c-homepage-news-widget starts here -->
<?php
...
if ($the_query->have_posts()) {
    ...
    while ($the_query->have_posts()) {
        $the_query->the_post();
        get_template_part('src/components/c-news-article-item/view');
    }
...
?>
<a href="<?php the_permalink(129); ?>" class="o-see-all-link">See all news</a>
<!-- c-homepage-news-widget starts here -->
