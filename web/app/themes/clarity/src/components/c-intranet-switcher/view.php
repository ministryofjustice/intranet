    ...
    // Remove OSPT hardcoded link to old intranet below when site goes live.
        ...
        foreach ($modified_agency_array as $agency_id => $agency) {
            ...
            if ($agency_id != 'noms') {
                ...
                echo '<li class="c-intranet-switcher__switch c-intranet-switcher__switch--' . $agency_id . $extra_class . ' "><a href="https://hmpps.intranet.justice.gov.uk/">' . $agency['label'] . '</a></li>';
            }
        }
        ?>
