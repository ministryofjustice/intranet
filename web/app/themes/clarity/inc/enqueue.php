...
function clarity_admin_enqueue($hook)
{
    ...
    if ($hook == 'post-new.php' || $hook == 'post.php') :
        wp_enqueue_script('force_title_script', get_stylesheet_directory_uri() . '/inc/admin/js/force-title.js',
            array(), null, false);
        wp_enqueue_script('colour-contrast-checker',
            get_stylesheet_directory_uri() . '/inc/admin/js/colour-contrast-checker.js', array(), null, false);
        wp_localize_script('colour-contrast-checker', 'myAjax', ['ajaxurl' => admin_url('admin-ajax.php')]);

        wp_register_style('page-search-dropdown-filter',
            get_stylesheet_directory_uri() . '/inc/admin/css/page-search-dropdown-filter.css', array(), '0.2.0', 'all');
