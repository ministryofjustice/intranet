...
# Use --platform=linux/amd64 flag and match version numbers to ensure module and runtime compatibility.
FROM --platform=linux/amd64 nginxinc/nginx-unprivileged:1.29.5-alpine@sha256:42a7d7f2ee23e9f5a1dcdf3647ba5c585bbd18f79e79cd817e70e8cd61c55779 AS base-nginx
